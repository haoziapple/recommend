 ...
 * 公用时间工具类
 * 
 * @className:com.fzjt.xiaoliu.read.interfaces.util.DateUtils
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-10-24 下午12:37:38
 * @author:ZhangYun
 */
public class DateUtils
{
    ...
    /**
     * 将时间格式转换成字符串格式 yyyy-MM-dd HH:mm
     * 
     * @Description:年月日时分
     * @param dateDate
     * @return
     * @version:v1.0
     * @author:LiChangjiang
     * @date:2015-11-14 下午5:02:45
     */
    public static String dateToStrNoS(Date dateDate)
    {
        if (!StringTools.isNullOrEmpty(dateDate))
        {
     ...
     * @version:v1.0
     * @author:LiChangjiang
     * @date:2015-1-6 下午4:20:07
     */
    public static String getStringNow1()
    {
        Date currentTime = new Date();
