 ...
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-11-13 下午3:26:39
 * @author:TangKai
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class RspPropertyBody
{
    @XmlElement(name = "list")
    private RspPropertyList rspPropertyList = null;

    public RspPropertyList getRspPropertyList()
    {
        return rspPropertyList;
    }

    public void setRspPropertyList(RspPropertyList rspPropertyList)
    {
