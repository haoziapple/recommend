 ...
 *
 *
 * @className:com.fzjt.xiaoliu.read.interfaces.mould.affixs.QuerySkuAffixsByKey
 * @description:TODO
 * 
 * @version:v1.0.0 
 * @author:LiangJin
...
import com.fzjt.xiaoliu.read.interfaces.business.affixs.bean.sku.req.ReqAffixesBean;
 ...
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-11-14 下午4:17:25
 * @author:LiangJin
 */
public class QuerySkuAffixsByKey
{
    /**
     * 日誌
     */
    private static final Logger logger = Logger.getLogger(QuerySkuAffixsByKey.class);
    ...
    public String interfaceProcess(ServletRequest servletRequest, Document obj, AbstractApplicationContext cont)
    {
        ...
        {
            // xml转换成 业务 bean
            reqBean = (ReqAffixesBean) Obj2Xml.xml2Obj(obj.asXML(), ReqAffixesBean.class);
            ...
            // 非空判断
            // if (StringTools.isNullOrEmpty(reqBean.getReqAffixesBody())
            // ||
            // StringTools.isNullOrEmpty(reqBean.getReqAffixesBody().getReqAffixesInfo())
            // ||
            // StringTools.isNullOrEmpty(reqBean.getReqAffixesBody().getReqAffixesInfo().getSkuKey()))
            // {
            // result =
            ...
            //
            // String skuKey =
            // reqBean.getReqAffixesBody().getReqAffixesInfo().getSkuKey();
            ...
            // 如果info为空
            else if (StringTools.isNullOrEmpty(reqBean.getReqAffixesBody().getReqAffixesInfo()))
            {
            ...
            {
                skuKey = reqBean.getReqAffixesBody().getReqAffixesInfo().getSkuKey();
            ...
            // 业务处理
            list = affixesService.querySkuAffixsByKey(skuKey);
