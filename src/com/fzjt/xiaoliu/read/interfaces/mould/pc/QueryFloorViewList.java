 ...
 *
 *
 * @className:com.fzjt.xiaoliu.read.interfaces.mould.pc.QueryFloorViewList
 * @description:TODO
 * 
 * @version:v1.0.0 
 * @author:TangKai
...
import com.fzjt.xiaoliu.read.interfaces.business.pc.home.bean.floor.view.req.ReqViewBean;
import com.fzjt.xiaoliu.read.interfaces.business.pc.home.bean.floor.view.rsp.RspViewBean;
import com.fzjt.xiaoliu.read.interfaces.business.pc.home.bean.floor.view.rsp.RspViewBody;
import com.fzjt.xiaoliu.read.interfaces.business.pc.home.bean.floor.view.rsp.ViewInfo;
import com.fzjt.xiaoliu.read.interfaces.business.pc.home.bean.floor.view.rsp.ViewInfoList;
 ...
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-12-4 下午6:10:34
 * @author:TangKai
 */
public class QueryFloorViewList
{
    /**
     * 日志
     */
    private static final Logger logger = Logger.getLogger(QueryFloorViewList.class);
     ...
     * @version:v1.0
     * @author:TangKai
     * @date:2015-12-4 下午6:10:56
     */
    public String interfaceProcess(ServletRequest servletRequest, Document obj, AbstractApplicationContext cont)
    {
        // 定义业务bean
        ReqViewBean reqBean = null;
        RspViewBean rspBean = new RspViewBean();
        RspViewBody rspBody = new RspViewBody();
        List<ViewInfo> list = null;
        ViewInfoList rspList = new ViewInfoList();
        ...
        {
            // xml转换成 业务 bean
            reqBean = (ReqViewBean) Obj2Xml.xml2Obj(obj.asXML(), ReqViewBean.class);
            ...
            // 数据库交互
            list = floorService.queryViewList(reqBean.getReqBody().getReqInfo());
            ...
            // 接口返回信息转换
            Obj2Xml.obj2Xml(RspViewBean.class, rspBean, out);
            result = out.toString();
        }
