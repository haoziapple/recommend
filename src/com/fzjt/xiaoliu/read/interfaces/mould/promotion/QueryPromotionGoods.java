 ...
 *
 *
 * @className:com.fzjt.xiaoliu.read.interfaces.mould.promotion.QueryPromotionGoods
 * @description:TODO
 * 
 * @version:v1.0.0 
 * @author:TangKai
...
import com.fzjt.xiaoliu.read.interfaces.business.promotion.bean.list.rsp.RspPromListBean;
 ...
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-12-9 下午2:29:44
 * @author:TangKai
 */
public class QueryPromotionGoods
{
    /**
     * 日志
     */
    ...
    public String interfaceProcess(ServletRequest servletRequest, Document obj, AbstractApplicationContext cont)
    {
        ...
        RspPromListBean rspBean = new RspPromListBean();
        RspHead rspHead = null;

        // 返回业务bean
        RspPromListBody rspBody = null;
        ...
        try
        {
            ...
            // 查询活动商品信息
            rspBody = promotionService.queryPromGoodsInfo(promotionKey);
            ...
            // 接口返回信息转换
            Obj2Xml.obj2Xml(RspPromListBean.class, rspBean, out);
            result = out.toString();
        }
