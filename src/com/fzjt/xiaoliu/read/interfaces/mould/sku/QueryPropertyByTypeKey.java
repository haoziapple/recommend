 ...
 * @description:TODO
 * @version:v1.0.0
 * @date:2015-11-13 下午4:20:34
 * @author:TangKai
 */
public class QueryPropertyByTypeKey
{

    // 日志
    private static final Logger logger = Logger.getLogger(QueryPropertyByTypeKey.class);
    ...
    public String interfaceProcess(ServletRequest servletRequest, Document obj, AbstractApplicationContext cont)
    {
        ...
        try
        {
            ...
            // ||
            // StringTools.isNullOrEmpty(reqBean.getReqPropertyBody().getReqPropertyInfo().getTypeKey()))
            // {
            // result =
            ...
            // // 返回商品所属类型key
            // String typeKey =
            // StringTools.removeSpace(reqBean.getReqPropertyBody().getReqPropertyInfo().getTypeKey());
            ...
            {
                typeKey = reqBean.getReqPropertyBody().getReqPropertyInfo().getTypeKey();
            ...
            // 数据库交互，获取返回信息
            rspBody = goodsSkuService.queryPropertyByTypeKey(typeKey);
